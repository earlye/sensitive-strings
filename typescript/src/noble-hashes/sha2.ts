/**
 * Attribution: https://github.com/paulmillr/noble-hashes/blob/main/src/sha2.ts
 * Original license: MIT https://github.com/paulmillr/noble-hashes/blob/main/LICENSE
